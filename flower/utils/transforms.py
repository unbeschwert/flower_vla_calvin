...
class RobustColorJitter(nn.Module):
...
class RobustRandomErasing(nn.Module):
    def __init__(self, p=0.2, scale=[0.02, 0.33], ratio=[0.3, 3.3], value=0):
        super().__init__()
...
class RandomWordDropout(object):
